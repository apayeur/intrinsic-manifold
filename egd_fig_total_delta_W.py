...
save_fig_dir = f"results/egd/fig2-tanh-m5-zscoreTrue-zeroedavgxFalse-fitinterTrue"
if not os.path.exists(save_fig_dir):
    os.makedirs(save_fig_dir)

delta_W_lazy = np.load("data/egd/fig2-tanh-m5-zscoreTrue-zeroedavgxFalse-fitinterTrue-expW0.55/total_change_W_Fnorm.npy", allow_pickle=True).item()
delta_W_rich = np.load("data/egd/fig2-tanh-m5-zscoreTrue-zeroedavgxFalse-fitinterTrue-expW1.0/total_change_W_Fnorm.npy", allow_pickle=True).item()
