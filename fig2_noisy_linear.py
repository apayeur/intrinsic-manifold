...
def main():
    ...
    base_lr = 1. / size[1]
    lr_init = {0.55: base_lr, 1.: base_lr}  # learning rate for initial training
    lr = lr_init  # {0.55: nb_readouts**0.5*base_lr, 1.: 0.5*base_lr}  # learning rate during adaptation
    ...
    for exponent_W in exponents_W:
        ...
        tag = (
            f"fig2-noisylinear-dimthresh{95}-zscore{do_z_score}-zeroedavgx{global_mean_input_is_zero}"
